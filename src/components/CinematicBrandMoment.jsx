...
export default function CinematicBrandMoment() {
  ...
  return (
    <section className="relative min-h-screen py-28 sm:py-36 bg-brand-navy-deep text-white flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-[300px] h-[300px] bg-brand-green/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center w-full">
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-2xl border transition-all duration-300 cursor-pointer flex flex-col items-center text-center ${
                    isActive
                      ? 'bg-brand-blue/40 border-brand-green/60 shadow-lg scale-105 backdrop-blur-md'
        ...
        <div className="mt-20 pt-16 border-t border-white/10 max-w-3xl mx-auto">
          <p className="text-xs uppercase tracking-widest text-slate-400 font-semibold mb-3">
            The Core Truth
          </p>
          <h3 className="text-2xl sm:text-4xl md:text-5xl font-heading font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-slate-300 tracking-tight leading-snug">
            EVERYTHING WORKS BETTER<br />
            WHEN IT WORKS TOGETHER.
          </h3>
          <p className="text-sm sm:text-base text-slate-400 mt-4 max-w-xl mx-auto font-normal">
